...
public class StatusBarUtil {
     ...
     * @param statusBarAlpha 状态栏透明度
     */
    public static void setTranslucent(Activity activity, @FloatRange(from = 0.0, to = 1.0) double statusBarAlpha) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
        setTransparent(activity);
        addTranslucentView(activity, (int) (statusBarAlpha * 255));
    }
