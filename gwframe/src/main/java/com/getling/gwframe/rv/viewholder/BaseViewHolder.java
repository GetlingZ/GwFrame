...
/**
 * @Author: getling
 * @CreateDate: 2019/5/6 14:05
 * @Description: https://github.com/CymChad/BaseRecyclerViewAdapterHelper
 */
...
//                                adapter.getOnItemChildLongClickListener().onItemChildLongClick(adapter, v, getClickPosition());
     ...
     * @return The BaseViewHolder for chaining.
     */
    protected BaseViewHolder setAdapter(BaseRecyclerViewAdapter adapter) {
